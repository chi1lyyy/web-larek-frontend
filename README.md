...
2. Слой отображения. Отвечает за отображение данных. Включает в себя **Page**, **ModalWindow** (общая структура модальных окон), **ProductView**, **CartView**, **OrderView**, **ClientView**, **SuccessModal**
